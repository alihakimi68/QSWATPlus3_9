...
class Ui_drawshapedialog(object):
    ...
    def setupUi(self, drawshapedialog):
        ...
        drawshapedialog.resize(430, 524)
        self.button_box = QtWidgets.QDialogButtonBox(drawshapedialog)
        self.button_box.setGeometry(QtCore.QRect(50, 480, 341, 32))
        ...
        self.Labletest.setGeometry(QtCore.QRect(240, 30, 130, 21))
        ...
        self.groupBox_status.setGeometry(QtCore.QRect(20, 190, 391, 281))
        self.groupBox_status.setObjectName("groupBox_status")
        self.tableWidget = QtWidgets.QTableWidget(self.groupBox_status)
        self.tableWidget.setGeometry(QtCore.QRect(20, 30, 351, 191))
        ...
        self.toolButton_load.setGeometry(QtCore.QRect(100, 240, 121, 21))
        self.toolButton_load.setObjectName("toolButton_load")
        self.toolButton_Refresh = QtWidgets.QToolButton(self.groupBox_status)
        self.toolButton_Refresh.setGeometry(QtCore.QRect(240, 240, 121, 21))
    ...
    def retranslateUi(self, drawshapedialog):
        ...
        self.Labletest.setText(_translate("drawshapedialog", "Category not selected"))
